...
Packages with breaking changes:
 ...
 - [`audioplayers` - `v7.0.0-dev.0`](#audioplayers---v700-dev0)
 - [`audioplayers_android` - `v6.0.0-dev.0`](#audioplayers_android---v600-dev0)
 - [`audioplayers_darwin` - `v7.0.0-dev.0`](#audioplayers_darwin---v700-dev0)
 - [`audioplayers_linux` - `v5.0.0-dev.0`](#audioplayers_linux---v500-dev0)
 - [`audioplayers_platform_interface` - `v8.0.0-dev.0`](#audioplayers_platform_interface---v800-dev0)
 - [`audioplayers_web` - `v6.0.0-dev.0`](#audioplayers_web---v600-dev0)
 - [`audioplayers_windows` - `v5.0.0-dev.0`](#audioplayers_windows---v500-dev0)
...
#### `audioplayers` - `v7.0.0-dev.0`
 ...
 - **REFACTOR**: Lint Swift ([#1613](https://github.com/bluefireteam/audioplayers/issues/1613)). ([9ae526e0](https://github.com/bluefireteam/audioplayers/commit/9ae526e079e5fcf2d2de228531a8bbfda7f1d984))
 - **REFACTOR**: Lint Kotlin, C and C++ code ([#1610](https://github.com/bluefireteam/audioplayers/issues/1610)). ([58d053fd](https://github.com/bluefireteam/audioplayers/commit/58d053fd0cbffa0ec00dac2a066d30a751357925))
 ...
 - **FIX**: Cancel `onPreparedSubscription` on error ([#1660](https://github.com/bluefireteam/audioplayers/issues/1660)). ([d008958f](https://github.com/bluefireteam/audioplayers/commit/d008958fab9405e750d350c8e24589ba3f1316d8))
 - **FIX**: Return null for duration and position, if not available ([#1606](https://github.com/bluefireteam/audioplayers/issues/1606)). ([e162a2ee](https://github.com/bluefireteam/audioplayers/commit/e162a2ee6a6c8cc8b591fbf89856f537d7c6a4bd))
 - **FIX**: Set playback rate only when playing ([#1658](https://github.com/bluefireteam/audioplayers/issues/1658)). ([409f5d57](https://github.com/bluefireteam/audioplayers/commit/409f5d574342ecf0a10701aae86bf1e5bbce488e))
 ...
 - **FIX**: Improve Error handling for Unsupported Sources ([#1625](https://github.com/bluefireteam/audioplayers/issues/1625)). ([010713d1](https://github.com/bluefireteam/audioplayers/commit/010713d189e0218c277c98139a788147894f9108))
 ...
 - **FEAT**(windows): Support for BytesSource on Windows ([#1601](https://github.com/bluefireteam/audioplayers/issues/1601)). ([b2bc3d98](https://github.com/bluefireteam/audioplayers/commit/b2bc3d9883901c20e0c42c2a64d4bfdd38f26e71))
 ...
 - **FEAT**: Allow adding custom media sources to example ([#1637](https://github.com/bluefireteam/audioplayers/issues/1637)). ([f71e9133](https://github.com/bluefireteam/audioplayers/commit/f71e91337d9b7816199366e67e80397eacda7211))
 ...
 - **DOCS**: Deploy live example app to GH pages ([#1623](https://github.com/bluefireteam/audioplayers/issues/1623)). ([948e8dc6](https://github.com/bluefireteam/audioplayers/commit/948e8dc6e3235985ed4121d5cac47bf9968dd35e))
...
#### `audioplayers_android` - `v6.0.0-dev.0`
...
#### `audioplayers_darwin` - `v7.0.0-dev.0`
 ...
 - **FIX**: Set playback rate only when playing ([#1658](https://github.com/bluefireteam/audioplayers/issues/1658)). ([409f5d57](https://github.com/bluefireteam/audioplayers/commit/409f5d574342ecf0a10701aae86bf1e5bbce488e))
 - **FIX**: Improve Error handling for Unsupported Sources ([#1625](https://github.com/bluefireteam/audioplayers/issues/1625)). ([010713d1](https://github.com/bluefireteam/audioplayers/commit/010713d189e0218c277c98139a788147894f9108))
 - **FIX**(darwin): Start observing `AVPlayerItem.status` before being assigned to `AVPlayer` ([#1549](https://github.com/bluefireteam/audioplayers/issues/1549)). ([d67be16b](https://github.com/bluefireteam/audioplayers/commit/d67be16b0006795f77a9344575c39b7015ebb3f5))
 - **FIX**: Return null for duration and position, if not available ([#1606](https://github.com/bluefireteam/audioplayers/issues/1606)). ([e162a2ee](https://github.com/bluefireteam/audioplayers/commit/e162a2ee6a6c8cc8b591fbf89856f537d7c6a4bd))
 - **FIX**: test and fix compatibility with min flutter version ([#1510](https://github.com/bluefireteam/audioplayers/issues/1510)). ([9f39e95f](https://github.com/bluefireteam/audioplayers/commit/9f39e95ff7913d8fc30fff27fef7aefc32de26fb))
 - **FIX**: onPrepared event to wait until player is ready / finished loading the source ([#1469](https://github.com/bluefireteam/audioplayers/issues/1469)). ([50f56365](https://github.com/bluefireteam/audioplayers/commit/50f56365f8e512df0fc5bdb7222614389cbd4ea0))
 - **FIX**: rework dispose ([#1480](https://github.com/bluefireteam/audioplayers/issues/1480)). ([c64ef6d9](https://github.com/bluefireteam/audioplayers/commit/c64ef6d914a52743128c717b90c4da0abbd7538d))
...
#### `audioplayers_linux` - `v5.0.0-dev.0`
 ...
 - **FEAT**: Release source for Web, Linux, Windows ([#1517](https://github.com/bluefireteam/audioplayers/issues/1517)). ([c666217b](https://github.com/bluefireteam/audioplayers/commit/c666217bdfe6f1194032d4f80ba2ac41d4d6baf1))
 - **FEAT**: Adapt position update interval of darwin, linux, web  ([#1492](https://github.com/bluefireteam/audioplayers/issues/1492)). ([ab5bdf6a](https://github.com/bluefireteam/audioplayers/commit/ab5bdf6a2bcbf7e984d4d897e43a67b3684c52d8))
 ...
 - **FEAT**: Upgrade flame lint dependency ([#1132](https://github.com/bluefireteam/audioplayers/issues/1132)). ([0d6dae3e](https://github.com/bluefireteam/audioplayers/commit/0d6dae3efc4a73abeb554fd0862d64fda0269066))
 - **FEAT**: Linux platform support (closes [#798](https://github.com/bluefireteam/audioplayers/issues/798)) ([#1110](https://github.com/bluefireteam/audioplayers/issues/1110)). ([74616c54](https://github.com/bluefireteam/audioplayers/commit/74616c5471fb942d8f08c41de50c93d4387f8916))
 - **DOCS**: Manual Flutter installation on Linux setup ([#1631](https://github.com/bluefireteam/audioplayers/issues/1631)). ([ab70f505](https://github.com/bluefireteam/audioplayers/commit/ab70f505943d9d747138aab197339b58491f37e2))
 - **DOCS**: update AudioCache explanation, migration guide, replace package READMEs ([#1457](https://github.com/bluefireteam/audioplayers/issues/1457)). ([b8eb1974](https://github.com/bluefireteam/audioplayers/commit/b8eb197435631fafeaa9a26eb76aca8e43e86420))
...
#### `audioplayers_platform_interface` - `v8.0.0-dev.0`
 ...
 - **FEAT**: create, dispose & reuse event stream ([#1609](https://github.com/bluefireteam/audioplayers/issues/1609)). ([1f8d23a1](https://github.com/bluefireteam/audioplayers/commit/1f8d23a1911e586cd7022bc589a0ec73bedab7fb))
 - **FEAT**: replace `Platform.isX` with `defaultTargetPlatform` ([#1446](https://github.com/bluefireteam/audioplayers/issues/1446)). ([6cd5656c](https://github.com/bluefireteam/audioplayers/commit/6cd5656c0c5deaab1fb4af78a5b7632402c3a1d3))
 - **FEAT**: extract AudioContext from audio_context_config ([#1440](https://github.com/bluefireteam/audioplayers/issues/1440)). ([e59c3b9f](https://github.com/bluefireteam/audioplayers/commit/e59c3b9f07c1a72f9bf4e424fa3b011645f191d2))
 - **FEAT**: Upgrade flame lint dependency ([#1132](https://github.com/bluefireteam/audioplayers/issues/1132)). ([0d6dae3e](https://github.com/bluefireteam/audioplayers/commit/0d6dae3efc4a73abeb554fd0862d64fda0269066))
...
#### `audioplayers_web` - `v6.0.0-dev.0`
 ...
 - **FEAT**(web): add setBalance ([#58](https://github.com/bluefireteam/audioplayers/issues/58)) ([#1282](https://github.com/bluefireteam/audioplayers/issues/1282)). ([782fc9df](https://github.com/bluefireteam/audioplayers/commit/782fc9dff24a2ab9681496fd7c4c8fed451eac35))
 - **FEAT**: Upgrade flame lint dependency ([#1132](https://github.com/bluefireteam/audioplayers/issues/1132)). ([0d6dae3e](https://github.com/bluefireteam/audioplayers/commit/0d6dae3efc4a73abeb554fd0862d64fda0269066))
 - **FEAT**: Add onPlayerCompletion, onPlayerStateChanged and onDurationChanged for web ([#1123](https://github.com/bluefireteam/audioplayers/issues/1123)). ([760e0c94](https://github.com/bluefireteam/audioplayers/commit/760e0c9443f4c63aadf4c5498767aeac6cd79346))
 - **DOCS**: update AudioCache explanation, migration guide, replace package READMEs ([#1457](https://github.com/bluefireteam/audioplayers/issues/1457)). ([b8eb1974](https://github.com/bluefireteam/audioplayers/commit/b8eb197435631fafeaa9a26eb76aca8e43e86420))
 - **DOCS**: Fix repos and homepages on pubspecs ([#1349](https://github.com/bluefireteam/audioplayers/issues/1349)). ([0bdde4d9](https://github.com/bluefireteam/audioplayers/commit/0bdde4d9f8f62487cdcfe96221216eba03b31060))
 - **BREAKING** **REFACTOR**: prevent from confusing and conflicting class names ([#1465](https://github.com/bluefireteam/audioplayers/issues/1465)). ([7cdb8586](https://github.com/bluefireteam/audioplayers/commit/7cdb858605f24f0abd1a225e04922830233f3e96))
 - **BREAKING** **REFACTOR**: improve separation of global audioplayer interface ([#1443](https://github.com/bluefireteam/audioplayers/issues/1443)). ([c0b3f85c](https://github.com/bluefireteam/audioplayers/commit/c0b3f85c477f0313299cc2a2898840d6c7d8dcd9))
...
#### `audioplayers_windows` - `v5.0.0-dev.0`
